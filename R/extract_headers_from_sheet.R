...
#'
#' @param .spreadsheet `<chr>` the full path to the workbook file
#' @param .sheet `<chr|int>` the name or number of the sheet to parse
#' @param .nrows `<int>` the number of rows to investigate as headers
#'
#' @return `<obj>` a tibble with 1 + `.nrows` columns.
#' \describe{
